...
// 008
Route::get('all-orders', 'Admin\OrderController@getAllOrders')->name('all-orders');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        // Shiprocket routes
        Route::group(['prefix' => 'shiprocket', 'as' => 'shiprocket.', 'middleware' => ['module:system_settings']], function () {
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.', 'middleware' => ['module:user_section']], function () {
            ...
            // // 008
            Route::post('update_certificate/{id}', 'SellerController@shop_certificate_update')->name('update_certificate');
            Route::post('update_pickup_added_on_shiprocket_status/{id}', 'SellerController@shop_pickup_added_on_shiprocket_status_update')->name('update_pickup_added_on_shiprocket_status');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
            ...
            Route::post('update-dimensions-of-order','OrderController@update_dimensions_of_order')->name('update-dimensions-of-order'); //update dimensions of order
