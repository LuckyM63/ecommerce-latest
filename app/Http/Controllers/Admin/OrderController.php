...
// 008
    ...
    {
        $orders = Order::all(); // Fetch all orders from the 'orders' table

        return response()->json($orders); // You can return the orders in JSON format or modify as needed
    }
// 008
    use CommonTrait;
    ...
    public function update_deliver_info(Request $request)
    {
        ...
        $order->third_party_delivery_shipment_id = $request->third_party_delivery_shipment_id;
    ...
    public function update_dimensions_of_order(Request $request)
    {
        $order = Order::find($request->order_id);
