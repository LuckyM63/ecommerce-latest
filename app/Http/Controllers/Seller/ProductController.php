...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 008
            'product_height'        => 'required_if:product_type,==,physical',
            'product_length'        => 'required_if:product_type,==,physical',
            'product_breadth'       => 'required_if:product_type,==,physical',
            'product_weight'        => 'required_if:product_type,==,physical',
            ...
            'product_height.required_if'        => 'height is required!',
            'product_length.required_if'        => 'length is required!',
            'product_breadth.required_if'        => 'breadth is required!',
            'product_weight.required_if'        => 'weight is required!',
        ...
        $product->product_height        = $request->product_type == 'physical' ? $request->product_height : null;
        $product->product_length        = $request->product_type == 'physical' ? $request->product_length : null;
        $product->product_breadth       = $request->product_type == 'physical' ? $request->product_breadth: null;
        $product->product_weight        = $request->product_type == 'physical' ? $request->product_weight : null;
