...
CREATE TABLE `orders` (
  ...
  `third_party_delivery_shipment_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `third_party_delivery_AWB_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `shops` (
  ...
  `pinCode` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,

  `pickup_city` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_state` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_country` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_pinCode` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_added_on_shiprocket`  BOOLEAN NOT NULL DEFAULT FALSE,
  `business_pan` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  -- 008
  `image` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'def.png',
  ...
  -- 008
  `gst_certificate` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `import_license` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seller_license` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ayush_license` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `factory_license` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `registration_certificate` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iso_certificate` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `international_license` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  -- 008
