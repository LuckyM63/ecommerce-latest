...
<div class="container py-5 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
    ...
    <h3 class="mb-3 text-center"> {{translate('Business')}} {{translate('Application')}}</h3>
        ...
        <div class="card __card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                    <!-- <label for="shop_address" class="title-color d-flex gap-1 align-items-center"> <span class="text-info">( * {{translate('must_include_House_No./Flat_No.')}} )</span></label> -->
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="house_no" class="form-control" id="house_no" placeholder="{{ translate('House No./Flat No.') }}" value="{{ old('house_no') }}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" name="street_no" class="form-control" id="street_no" placeholder="{{ translate('Street No.') }}" value="{{ old('street_no') }}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" name="shop_city" class="form-control" id="shop_city" placeholder="{{ translate('shop_city') }}" value="{{ old('shop_city') }}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" name="shop_state" class="form-control" id="shop_state" placeholder="{{ translate('shop_state') }}" value="{{ old('shop_state') }}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" name="shop_country" class="form-control" id="shop_country" placeholder="{{ translate('shop_country') }}" value="{{ old('shop_country') }}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="number" name="shop_pincode" class="form-control" id="shop_pincode" placeholder="{{ translate('shop_pincode') }}" value="{{ old('shop_pincode') }}" required>
                    </div>
                    ...
                    <div id="pickup_address_fields" style="display: block;">
                        <div class="row g-3">
                        <div class="col-sm-12">
                        <label for="pickup_address" class="title-color d-flex gap-1 align-items-center"> <span class="text-info"></span></label>

                            <textarea name="pickup_address" class="form-control" id="pickup_address" rows="1" placeholder="{{translate('pickup_address ')}}">{{old('pickup_address')}}</textarea>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-sm-12 ">
                    <div>{{translate('Business_PAN_No.')}}</div>
                        <input type="text" class="form-control form-control-user" id="business_pan" name="business_pan" placeholder="{{translate('business_PAN_No.')}}" value="{{old('business_pan')}}" >
                    </div>
                    <div class="col-sm-6">
                        <div class="pb-3">
                            <center>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('GST_Certificate')}}</div>
                            <div class="custom-file">
                                
                                <input type="file" name="gst_certificate" id="gst_certificate" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('Import_License')}}</div>
                            <div class="custom-file">
                                <input type="file" name="import_license" id="import_license" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('Seller_License')}}</div>
                            <div class="custom-file">
                                <input type="file" name="seller_license" id="seller_license" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('Ayush_License')}}</div>
                            <div class="custom-file">
                                <input type="file" name="ayush_license" id="ayush_license" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('Factory_License')}}</div>
                            <div class="custom-file">
                                <input type="file" name="factory_license" id="factory_license" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('Registration_Certificate')}}</div>
                            <div class="custom-file">
                                <input type="file" name="registration_certificate" id="registration_certificate" class="custom-file-input"
                                    accept=".pdf">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('ISO_9001_Certificate')}}</div>
                            <div class="custom-file">
                                <input type="file" name="iso_9001_certificate" id="iso_9001_certificate" class="custom-file-input"
                                    accept=".pdf">
                                <label class="custom-file-label" for="iso_9001_certificate">{{translate('upload_document')}}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group mb-0">
                        <div>{{translate('ISI/BSI/International_License')}}</div>
                            <div class="custom-file">
                                <input type="file" name="international_license" id="international_license" class="custom-file-input"
                                    accept=".pdf">
                                <label class="custom-file-label" for="interntional_license">{{translate('upload_document')}}</label>
                            </div>
                        </div>
                    </div>
                <!-- 008 -->
