            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                <label class="title-color" for="product_height">{{ translate('product_height (in cm.)') }}</label>
                                <input type="number" min="0" 
                                        placeholder="{{ translate('product_height') }}"
                                        value="{{ $product->product_height }}" name="product_height"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                <label class="title-color" for="product_length">{{ translate('product_length (in cm.)') }}</label>
                                <input type="number" min="0" 
                                        placeholder="{{ translate('product_length') }}"
                                        value="{{ $product->product_length }}" name="product_length"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                <label class="title-color" for="product_breadth">{{ translate('product_breadth (in cm.)') }}</label>
                                <input type="number" min="0" 
                                        placeholder="{{ translate('product_breadth') }}"
                                        value="{{ $product->product_breadth }}" name="product_breadth"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                <label class="title-color" for="product_weight">{{ translate('product_weight (in kg)') }}</label>
                                <input type="number" min="0" 
                                        placeholder="{{ translate('product_weight') }}"
                                        value="{{ $product->product_weight }}" name="product_weight"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-9">
