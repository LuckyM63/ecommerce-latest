                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" 
                                        ...
                                        value="{{ old('product_height') }}" name="product_height"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" 
                                        ...
                                        value="{{ old('product_length') }}" name="product_length"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" 
                                        ...
                                        value="{{ old('product_breadth') }}" name="product_breadth"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" 
                                        ...
                                        value="{{ old('product_weight') }}" name="product_weight"
                                        class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-9">
