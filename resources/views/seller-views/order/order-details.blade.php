                    ...
                    <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">
                        <div class="d-flex flex-column gap-10">
                            ...
                            <div class="d-flex flex-wrap gap-10">
                                ...
                                <a href="{{route('seller.orders.details',[$linked['id']])}}" class="btn color-caribbean-green text-white rounded py-1 px-2">{{$linked['id']}}</a>
                                @endforeach
                            </div>
                            @endif
                        ...
                        <div class="text-sm-right">
                            <div class="d-flex flex-wrap gap-10 justify-content-end">
                                ...
                                <a class="btn btn--primary px-4" target="_blank" href="{{route('seller.orders.generate-invoice',[$order['id']])}}">
        ...
        <div class="col-lg-4 d-flex flex-column gap-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="mr-3">
                            <img class="avatar rounded avatar-70" src="{{!empty($order->seller->shop) ? asset('storage/app/public/seller/'.auth('seller')->user()->image) : ''}}" onerror="this.src='{{asset('public/assets/back-end/img/160x160/img2.jpg')}}'" alt="">
                        </div>
                    ...
                    <div class="col-12">
                        <form action="{{route('seller.orders.update-deliver-info')}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn--primary" onclick="change_order_status('confirmed')" type="submit">{{translate('update')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('seller.orders.update-dimensions-of-order')}}" method="POST">
                            @csrf
                            <input type="hidden" name="order_id" value="{{$order['id']}}">
                            <div class="card-body">
                                <div class="form-group">
    ...
    async function track_shipRocket_shipment() {
        try {
            ...
            switch (currentStatus) {
                case 'PICKED UP':
                    change_order_status('intransit');
                    break;
                case 'OUT FOR DELIVERY':
                    change_order_status('out_for_delivery');
                    break;
                case 'Delivered':
                    change_order_status('delivered');
                    break;
                    // case 'CANCELED':
                    //     changeDeliveryStatus('canceled');
                    //     break;
                case 'Return Delivered':
                    change_order_status('returned');
                    break;
                case 'Undelivered':
