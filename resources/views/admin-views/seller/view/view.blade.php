                    ...
                    <div class="certificates-list">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="value">
                                ...
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->gst_certificate) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->gst_certificate) }}" download="{{ $seller->shop->name }}_gst_certificate.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="value">
                                ...
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->import_license) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->import_license) }}" download="{{ $seller->shop->name }}_import_license.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('Seller License') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->seller_license)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->seller_license) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->seller_license) }}" download="{{ $seller->shop->name }}_seller_license.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('Ayush License') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->ayush_license)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->ayush_license) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->ayush_license) }}" download="{{ $seller->shop->name }}_ayush_license.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('Factory License') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->factory_license)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->factory_license) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->factory_license) }}" download="{{ $seller->shop->name }}_factory_license.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('Registration Certificate') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->registration_certificate)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->registration_certificate) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->registration_certificate) }}" download="{{ $seller->shop->name }}_registration_certificate.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('ISO Certificate') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->iso_certificate)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->iso_certificate) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->iso_certificate) }}" download="{{ $seller->shop->name }}_iso_certificate.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <span class="key text-nowrap">{{ translate('ISI/BSI International License') }}</span>
                            <span>:</span>
                            <span class="value">
                                @if($seller->shop->international_license)
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->international_license) }}" target="_blank" class="btn btn-sm btn-info">{{ translate('View') }}</a>
                                <a href="{{ asset('storage/app/public/shop/certificates/' . $seller->shop->international_license) }}" download="{{ $seller->shop->name }}_international_license.pdf" class="btn btn-sm btn-primary">{{ translate('Download') }}</a>
                                @else
                                {{ translate('Not Available') }}
                                @endif
                            </span>
