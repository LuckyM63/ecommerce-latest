...
@section('content')
    ...
    @if ($product->sub_category)
        ...
        <a href="http://localhost/ecommerce/products?id=47&data_from=category&page=1"
            style="padding: 5px; font-weight: bold; font-size: 16px;">{{ $product->sub_sub_category->name }}></a>
    @endif
                                    ...
                                    <div class="mt-3">
                                        <div class="product-quantity d-flex flex-column __gap-15">
                                            ...
                                            <div id="chosen_price_div">
                                                <div
                                                    class="d-none d-sm-flex justify-content-start align-items-center {{ Session::get('direction') === 'rtl' ? 'ml-2' : 'mr-2' }}">
                                                    <div
                                                            ...
                                                            <div class="col-12">
                                                                <div
                                                                    ...
                                                                    <button class="btn text-white view_more_button"
                                                                        ...
                                                                        onclick="load_review()">{{ translate('view_more') }}</button>
                                                                </div>
                                                            </div>
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="chat_with_seller-btns">
                                            ...
                                            @else
                                                <a href="{{ route('customer.auth.login') }}"
                                                    class="btn w-100 d-block text-center"
                                                    style="background: {{ $web_config['primary_color'] }};color:#ffffff">
                                                    <img src="{{ asset('/public/assets/front-end/img/chat-16-filled-icon.png') }}"
                                                        class="mb-1" alt="">
                                                    <span
            ...
            <div class="d-flex flex-column gap-1 py-2">
                <div class="d-flex justify-content-center align-items-center fs-13">
                    <div class="product-description-label text-dark font-bold"><strong
                            class="text-capitalize">{{ translate('total_price') }}</strong> : </div>
