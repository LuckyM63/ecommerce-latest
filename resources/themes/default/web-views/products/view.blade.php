                            ...
                            <div class="text-center">
                                ...
                                <div class="__cate-side-price pb-3">
                                    <div class="input-group-overlay input-group-sm">
                                        <input
                                            style="{{ Session::get('direction') === 'rtl' ? 'padding-right: 32px;' : '' }}"
                                                    ...
                                                    <div class="card-body p-0 {{ Session::get('direction') === 'rtl' ? 'mr-2' : 'ml-2' }}"
                                                        ...
                                                        @foreach ($child->childes as $ch)
                                                            <div class="card-header">
                                                                <label
                                                                    class="for-hover-lable d-block cursor-pointer text-left"
            ...
            <section class="col-lg-9">
                ...
                @else
                    <div class="text-center pt-5 text-capitalize">
                        ...
                        <p class="text-center text-muted">{{ translate('sorry_no_data_found_related_to_your_search') }}
                        </p>
                    </div>
                @endif
            </section>
